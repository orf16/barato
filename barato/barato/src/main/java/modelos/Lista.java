...
public class Lista  implements java.io.Serializable {
    ...
    public Lista(int idlista, Usuario usuario, UsuarioDireccion usuarioDireccion, Date fechacreada, Short estado, String nombrelista, String key, Set listasCompartidases, Set listaProductos) {
       this.idlista = idlista;
